...
class Config
{
    ...
    public static function registerCoreWorkflowEvents()
    {
        ...
        self::$workflowEventsManager->get('appointment_paid')
                                    ...
                                    ->setAvailableParams(['appointment_id', 'location_id', 'service_id', 'staff_id', 'customer_id', 'check']);
    ...
    public static function registerCoreShortCodes()
    {
        ...
        // atef
        $shortCodeService->registerShortCode( 'cash', [
            'name'      =>  bkntc__('cash'),
            'cash'      =>   'cash_info',
            'category'  =>  'appointment_info',
        ] );

        $shortCodeService->registerShortCode( 'check', [
            'name'      =>  bkntc__('check'),
            'check'      =>   'check',
            'category'  =>  'appointment_info',
        ] );

        $shortCodeService->registerShortCode( 'card', [
            'name'      =>  bkntc__('card'),
            'card'      =>   'card',
            'category'  =>  'appointment_info',
        ] );
